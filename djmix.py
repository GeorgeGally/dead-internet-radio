...
def main():
    ...
    parser.add_argument(
        "--output", "-o",
        default="",
        help="Output path (default: output/mix/<mix-name>.mp3)",
    )
    parser.add_argument(
        "--title",
        default="",
    ...
    parser.add_argument(
        ...
        type=float,
        default=4,
        help="Cross-fade duration in seconds (default: 4)",
    )
    parser.add_argument(
        "--offset",
        type=float,
    ...
    default_out = str(input_dir.parent / "mix" / meta.output_filename())
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Phase 2: Overlay all voices on the padded music mix
            # Opening is treated as a voice at position 0 (talks over the music intro)
            ...
            overlay_voices(music_mix, voice_placements, output_path,
