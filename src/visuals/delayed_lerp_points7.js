...
visuals.register('delayed_lerp_points7', (() => {
  let myP5 = null;
  ...
  function start() {
    ...
    myP5 = new p5((p) => {
      ...
      function drawTrail() {
        ...
        ctx.fill(0, 40);
        ctx.ellipse(0, line2_sz + sz / 2, 2, 2);

        ctx.fill(angle, 111, 122, 2);
        ctx.stroke(startH + angle2, angle * 0.1, 100, 12);
        if (bw) ctx.stroke(0, 0, 0, 12);
        ctx.noFill();
  ...
  return { name: 'Delayed Lerp Points 7', start, stop };
})());
